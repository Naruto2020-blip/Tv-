...
object OnlineEpgSources {
    val allSources: List<OnlineEpgSource> = listOf(
        // 1. GatoTV (IPTV-org grabber de GatoTV.com)
        OnlineEpgSource(
            id = "gatotv_cr",
            name = "GatoTV EPG (gatotv.com)",
            provider = "GatoTV",
            url = "https://raw.githubusercontent.com/iptv-org/epg/master/sites/gatotv.com/gatotv.com.channels.xml"
        ),
        // 2. AmericaTVGuide / Mi.tv EPG (Guía para Costa Rica y Centroamérica)
        OnlineEpgSource(
            id = "americatvguide_cr",
            name = "AmericaTVGuide / Mi.tv (Centroamérica)",
            provider = "AmericaTVGuide",
            url = "https://iptv-org.github.io/epg/guides/es/mi.tv.xml.gz"
        ),
        // 3. EPG.lat - Costa Rica daily XMLTV (comprimido GZ)
        OnlineEpgSource(
            id = "epg_lat_cr",
        ...
        // 4. EPG.lat - Costa Rica directo XML (espejo sin compresión)
        OnlineEpgSource(
            id = "epg_lat_cr_raw",
        ...
        // 6. IPTV-org / GitHub - globetvapp Costa Rica
        OnlineEpgSource(
        ...
        // 8. TDTChannels Guía Completa TDT
        OnlineEpgSource(
            id = "tdtchannels",
